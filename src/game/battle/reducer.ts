...
export type BattleAction =
  | { type: 'ATTACK'; quality?: QteQuality }
...
/** attackerSide 的 active 打 targetSide 的 active，套用傷害、推 events、必要時強制換 / 結束。 */
function performAttack(w: BattleState, attackerSide: Side, params: AttackParams, events: BattleEvent[]): void {
  ...
  const attacker = activeOf(w, attackerSide)
  ...
  events.push({
    type: 'damageApplied',
    attackerSide,
    attackerIndex: w[attackerSide].activeIndex,
    targetSide,
    targetIndex,
