...
| `09-extension-systems.md` | **延伸系統設計**（5 個可模組化/可選掛載系統 + 統一掛載機制 + 回合相位契約，排 M6）（三方圓桌選 5 + 設計審查） |
...
| **M6** | 延伸系統群（可選掛載）：M6.0 掛載地基+相位契約 → 羈絆 / 道具 / 進化 / 連鎖 / 連勝塔 → `09-extension-systems.md` | 🧩 可選式深度 |
