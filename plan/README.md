...
| `16-mobie-card-partner-rename.md` | **Mobie 資訊卡（M16）+ Partner 技能系（M17）+ 全面改名（M18）**（使用者實玩回饋：看不到自己夥伴資訊 +「夥伴而非從屬」理念 + pokemon→mobie 全面正名；M17 提前 M12 核心、M18 取代 M15） |
...
| **M17** | Partner 技能系：夥伴技能 loadout（自動 hook + 1 主動看穿槽）+ 完整 SP 訓練經濟（**提前並重定位 M12 核心**，複用 M7/M8 地基）→ `16` | 🤝 夥伴技能 |
